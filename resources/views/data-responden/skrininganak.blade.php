...
@section('script')
    ...
    <script>                
        if(window.location.href == "{{url('/responden/anak/filtered')}}" || window.location.href == "{{url('/responden/anak/filtered/semua')}}") {
            window.location.href = "{{url('/responden/anak')}}"                
        }
