            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="row clearfix">                        
                        <div class="col-sm-12">                            
                            <h6>Filter</h6>
                            <form action="{{route('responden-anak')}}" method="get">
                                <select class="form-control show-tick" name="alamat">                                
                                ...
                                <button type="submit" class="btn btn-block btn-lg bg-green waves-effect">TERAPKAN</button>
                            </form>                            
                        </div>
                    </div>
                    <br>
