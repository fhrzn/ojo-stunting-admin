...
@section('script')
    ...
    <script>                
        if(window.location.href == "{{url('/responden/ibu-hamil/filtered')}}" || window.location.href == "{{url('/responden/ibu-hamil/filtered/semua')}}") {
            window.location.href = "{{url('/responden/ibu-hamil')}}"                
        }
    
        $('#toggle-skrining').addClass('active');
        $('#skrining-ibuhamil').addClass('active');        
        ...
        $('#btn-submit').on('click', function(e) {
            ...
            let url = "{{url('/responden/ibu-hamil')}}"
